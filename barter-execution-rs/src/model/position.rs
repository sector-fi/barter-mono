...
impl PositionBuilder {
    ...
    pub fn build(self) -> Result<Position, PositionError> {
        Ok(Position {
            ...
            meta: self.meta.ok_or(PositionError::BuilderIncomplete("meta"))?,
            side: self.side.ok_or(PositionError::BuilderIncomplete("side"))?,
            quantity: self
                .quantity
                .ok_or(PositionError::BuilderIncomplete("quantity"))?,
            enter_fees: self
                .enter_fees
                .ok_or(PositionError::BuilderIncomplete("enter_fees"))?,
            enter_fees_total: self
                .enter_fees_total
                .ok_or(PositionError::BuilderIncomplete("enter_fees_total"))?,
            enter_avg_price_gross: self
                .enter_avg_price_gross
                .ok_or(PositionError::BuilderIncomplete("enter_avg_price_gross"))?,
            enter_value_gross: self
                .enter_value_gross
                .ok_or(PositionError::BuilderIncomplete("enter_value_gross"))?,
            exit_fees: self
                .exit_fees
                .ok_or(PositionError::BuilderIncomplete("exit_fees"))?,
            exit_fees_total: self
                .exit_fees_total
                .ok_or(PositionError::BuilderIncomplete("exit_fees_total"))?,
            exit_avg_price_gross: self
                .exit_avg_price_gross
                .ok_or(PositionError::BuilderIncomplete("exit_avg_price_gross"))?,
            exit_value_gross: self
                .exit_value_gross
                .ok_or(PositionError::BuilderIncomplete("exit_value_gross"))?,
            current_symbol_price: self
                .current_symbol_price
                .ok_or(PositionError::BuilderIncomplete("current_symbol_price"))?,
            current_value_gross: self
                .current_value_gross
                .ok_or(PositionError::BuilderIncomplete("current_value_gross"))?,
            unrealised_profit_loss: self
                .unrealised_profit_loss
                .ok_or(PositionError::BuilderIncomplete("unrealised_profit_loss"))?,
            realised_profit_loss: self
                .realised_profit_loss
                .ok_or(PositionError::BuilderIncomplete("realised_profit_loss"))?,
        })
    }
}
